        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea id="copyALL" rows="10" class="form-control" readonly>hitmaldalyq@hotmail.com|qKcIOa43
slatonsukete@hotmail.com|QKIQLD36
jakeeskalst@hotmail.com|g39AQ876
</textarea>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 text-left">
                    <div class="mb-3">
                        <a href="https://clonesnew.com/client/orders" type="button" class="btn btn-danger btn-sm"><i class="fas fa-arrow-left mr-1"></i>Quay Lại</a>
                    </div>
                </div>
